...
<main>
  <section>
    ...
    <div class="col-lg-4 mx-auto">
      <h1 class="display-7 fw-bold ">Navegação Segura na Web</h1>
    </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <br>
        <ul>
          <li><p class="lead "><mark>Vírus de computador</mark>: programas que se espalham e causam danos.</p><br><br></li>
          <li><p class="lead "><mark>Phishing</mark>: golpes que tentam enganar você para roubar senhas ou dados bancários.</p><br><br></li>
          <li><p class="lead "><mark>Roubo de identidade</mark>: quando alguém usa suas informações pessoais para cometer fraudes.</p><br></li>
        </ul>
      </div>
      <div class="col-md-5">
    ...
    <div class="col d-flex align-items-start"> 
      <div>
        <h3 class="fs-2 ">Por que manter seu sistema atualizado?</h3>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <br>
        <ul>
          <li><p class="lead ">O endereço deve começar com https:// (o “s” significa seguro).</p><br><br></li>
          <li><p class="lead ">Um ícone de cadeado deve aparecer ao lado do endereço no navegador.</p><br><br></li>         
        </ul>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <br>
        <ul>
          <li><p class="lead ">Dê preferência a plataformas conhecidas e seguras.</p><br><br></li>
          <li><p class="lead ">Use serviços de pagamento confiáveis, que oferecem criptografia e proteção contra fraudes (ex: PayPal, Mercado Pago).</p><br><br></li>
          <li><p class="lead ">Nunca compartilhe os dados do seu cartão por e-mail ou mensagem.</p><br></li>
        </ul>
      </div>
      <div class="col-md-5">
    ...
    <div class="col d-flex align-items-start"> 
      <div>
        ...
        <ul>
          <li><p class="lead ">Bancos</p></li>
          <li><p class="lead ">E-mails</p></li>
          <li><p class="lead ">Compras online</p></li>
        </ul>         
      </div>
    </div>
